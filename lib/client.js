...
array.map(async (reg) => {
    ...
    const handleBadWords = async (message) => {
		...
		const imagePath = './lib/assets/homa.jpg'; // Replace 'image_name.png' with the actual name of your image file
...
citel.reply("මේ අහපන්, කුනුහරුප තහනම්!!");

// Define the path to the image in lib/assets
const imagePath = 'lib/assets/homa.webp'; // Image path
...
let sticker = new Sticker(media, {
    pack: 'NBDEV WABOTS', // Replace with your pack name
    author: 'HOMATHAGAYU', // Replace with your author name
