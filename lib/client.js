...
const imageUrl = 'https://telegra.ph/file/a4370a8d2e1f6ab515383.jpg'; // Replace with the actual URL

// Download the image
const response = await axios.get(imageUrl, { responseType: 'arraybuffer' });
const media = Buffer.from(response.data, 'binary');

// Create the sticker
let sticker = new Sticker(media, {
    pack: 'homathagayu', // Replace with your pack name
    author: 'NBDEV', // Replace with your author name
